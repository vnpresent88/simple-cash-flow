...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" autocomplete="do-not-autofill" action="{{ route('pregister') }}"
                method="POST">
                ...
                <div class="wrap-input100 validate-input" data-validate="Enter password">
                    ...
                    <input class="input100" type="password" name="user-re-p" autocomplete="off">
                    <span class="focus-input100" data-placeholder="User Re-Password"></span>
                </div>
